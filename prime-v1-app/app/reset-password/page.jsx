...
export default function ResetPasswordPage() {
  ...
  async function handleUpdatePassword(e) {
    ...
    if (!password || !confirmPassword) {
      setErrorMessage("Entre et confirme ton nouveau mot de passe.");
      setLoading(false);
      return;
    }

    if (password.length < 6) {
      setErrorMessage("Ton mot de passe doit contenir au moins 6 caractères.");
      setLoading(false);
      return;
    }
    ...
    if (error) {
      setErrorMessage("Impossible de mettre à jour ton mot de passe. Le lien a peut-être expiré.");
      return;
    }

    setMessage("Ton mot de passe a été mis à jour. Redirection vers la connexion...");
  ...
  return (
    <main className="reset-page">
      ...
      <form className="card" onSubmit={handleUpdatePassword}>
        ...
        <div className="badge">Nouveau mot de passe</div>
        ...
        <p className="text">
          Choisis un nouveau mot de passe pour retrouver ton cockpit PRIME et continuer ta progression.
        </p>
