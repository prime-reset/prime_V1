...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    setDisciplineActive(discipline);
    setResetActive(reset);
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .prime-home {
          ...
          background-position: center, left -260px top -20px;
        ...
        @media(max-width: 768px) {
          .prime-home {
            ...
            background-position: center, left -240px top 0px;
          }
        }
        ...
        @media(max-width: 520px) {
          .prime-home {
            ...
            background-position: center, left -230px top -130px;
          }
        ...
        @media(max-width: 390px) {
          ...
          .prime-home {
            ...
            background-position: center, left -220px top -120px;
          }
        }
      `}</style>
      ...
      <div className="page">
        <section className="hero">
          ...
          <p className="subtitle">
            Discipline comportementale, coaching mental et système d’exécution
            pour traders.
          </p>
          ...
          <Link href="/offer" className="founder-link">
            👑 Accès Fondateur · 9,99€/mois
          </Link>
        </section>
        ...
        <section className="actions-grid">
          ...
          <ActionButton href="/onboarding" icon={<Sparkles size={24} />} label="PRIME" title="Identity" />
          <ActionButton href="/offer" icon={<Crown size={24} />} label="Fondateur" title="Offre" />
        </section>
