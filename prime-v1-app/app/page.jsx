...
export default function HomePage() {
  ...
  const [bestInsight, setBestInsight] = useState(null);
    ...
    if (identityData) {
      setProfile(
        identityData.profile ||
          "Trader en construction"
      );

      setAverageScore(
        identityData.discipline_average ||
          0
      );
    }
  ...
  const prescriptionProgress =
    activePrescription
      ? (
          activePrescription.compliance_days ||
          0
        ) +
        (
          activePrescription.missed_days ||
          0
        )
      : 0;
  ...
  const chartData =
    getDisciplineChartData(
      sessions
    );

  const structure =
    getBehaviorStructure(
      chartData
    );
      ...
      <style>{`
        * {
        ...
        .insight-confidence-dot {
          ...
          box-shadow:
            0 0 12px
            rgba(125,255,161,0.48);
        }

        .insight-separator {
          color:
            rgba(212,176,106,0.6);
        }
                .card,
        .score-panel,
        .workspace-card,
                ...
                <>
                  ...
                  <div className="insight-meta">
                    ...
                    <span>
                      Confiance{" "}
                      {getConfidenceLabel(
                        bestInsight.confidence
                      )}
                    </span>

                    <span className="insight-separator">
                      •
                    </span>

                    <span>
                      Analyse basée sur{" "}
                      {getInsightSessionCount(
                        bestInsight,
                        sessionsCount
                      )}{" "}
                      session
...
function getInsightSessionCount(
  insight,
  fallbackCount
) {
  const count =
...
function DisciplineTradingChart({
  data,
  score,
}) {
  const width = 360;
  ...
  if (
    ...
    return {
      ...
      label:
        "Risque élevé",
      message:
        "Tes trois dernières sessions montrent une discipline en baisse. PRIME recommande de réduire la taille et de viser une exécution parfaite.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      label:
        "Revenge détecté",
      message:
        "Deux signaux de revenge trading ont été détectés récemment. Après une perte, ton objectif est de t’arrêter avant de vouloir récupérer.",
    };
  }

  const overtradingCount =
    lastFive.filter(
      (session) =>
        session.dominant_error ===
        "Overtrading"
  ...
  if (
    ...
    return {
      ...
      label:
        "Overtrading",
      message:
        "PRIME détecte une tendance à multiplier les décisions. Aujourd’hui, limite-toi aux opportunités les plus propres.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      label:
        "FOMO à surveiller",
      message:
        "Tu as récemment poursuivi des opportunités au lieu d’attendre ton setup. Ton edge est dans l’attente.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      label:
        "Risque faible",
      message:
        "Aucune dérive majeure détectée sur tes dernières sessions. Continue à protéger ton cadre.",
    };
  }
...
function getScoreTrend(
  ...
  return {
    value:
      ...
      previous,
    label:
      "sur les 7 dernières sessions",
  };
}

function getBehaviorStructure(
  data
) {
  if (
    !data ||
  ...
  if (
    ...
    return {
      ...
      icon:
        "↗",
      message:
        "Tes dernières sessions montrent une amélioration de ton exécution.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      icon:
        "↘",
      message:
        "La qualité de ton exécution se dégrade. Reviens au setup et réduis les décisions impulsives.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      icon:
        "→",
      message:
        "Ta discipline est stable. Le prochain objectif est de sortir du range par le haut.",
    };
  }
  ...
  return {
    ...
    icon:
      "↗",
    message:
      "La structure reste constructive. Continue à protéger tes règles principales.",
  };
}
